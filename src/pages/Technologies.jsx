    ...
    <div className="relative w-full min-h-screen bg-gray-900 transition-colors duration-300">
      ...
      <div className="relative z-10 pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-16">
            {techCategories[activeCategory].map((tech, i) => (
              <div
                ...
                className="bg-black bg-opacity-30 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer group"
              >
          ...
          {/* Skills Overview */}
          <div className="bg-black bg-opacity-30 rounded-lg p-8 mb-16">
      ...
      {selectedTech && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-black bg-opacity-30 rounded-lg max-w-md w-full">
            <div className="p-6">
