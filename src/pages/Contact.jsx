  ...
  return (
    <div className="relative w-full min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200 transition-colors duration-300">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 max-w-sm w-full text-center">
            ...
            <div className="flex justify-center mb-6">
              <ReCAPTCHA
                sitekey="6Le942krAAAAALD3xpPFoFvw7_fAK3IyvHnZT--T"
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                ...
                className={`bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-lg transition ${!captchaValue ? "opacity-50 cursor-not-allowed" : ""}`}
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 max-w-sm w-full text-center">
            <h2 className="text-2xl font-bold mb-4 text-green-600">Mensagem enviada!</h2>
            <p className="mb-6 text-gray-700 dark:text-gray-200">
